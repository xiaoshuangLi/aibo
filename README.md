...
- 🔗 **MCP 工具集成**: 通过 `mcps/` 目录接入 GitHub、Slack、Claude Code、Cursor 等外部工具
...
| 🔧 工具 | 说明 |
|---------|------|
| 🐙 `github` | 访问 GitHub 仓库、创建 Issue、管理 PR |
| 💬 `slack` | 发送 Slack 消息、管理频道 |
| 🤖 `claude-code` | 接入 Claude Code MCP Server，增强代码分析与重构能力 |
| 🖱️ `cursor` | 接入 Cursor IDE MCP Server，实现自主编辑和代码生成 |
| 🔍 `web_search` | 网页搜索与内容抓取 |
...
> 📖 详细说明请参阅 **[mcps/README.md](mcps/README.md)**
...
| [mcps/README.md](mcps/README.md) | MCP 工具配置说明 |
