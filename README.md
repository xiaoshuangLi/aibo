...
- ✅ **结构化 Git 操作工具**: `git_operation` 工具提供类型安全的 Git 集成（status / diff / log / blame / add / commit / push / pull / checkout / branch / stash），返回结构化 JSON 响应，统一错误处理，对齐 Cursor / Claude Code 的 Git 集成深度
