...
function extractInlineQuotedTextCandidates(data: any, contentObj: any | null): string[] {
  ...
  const quotedPayloads = [
    ...
    contentObj?.reply,
    contentObj?.reply_message,
    contentObj?.replyMessage,
    contentObj?.replied_message,
    contentObj?.repliedMessage,
    contentObj?.message_reply,
    contentObj?.messageReply,
    contentObj?.parent_message,
    contentObj?.parentMessage,
    data?.quote,
    data?.quote_content,
    data?.quoted_message,
    data?.reply,
...
function extractReferencedMessageIds(message: any, contentObj: any | null): string[] {
  ...
  const ids = [
    ...
    contentObj?.reply?.message_id,
    contentObj?.reply_message?.message_id,
    contentObj?.replied_message?.message_id,
    contentObj?.message_reply?.message_id,
