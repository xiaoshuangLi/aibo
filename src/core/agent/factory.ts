...
import { findSkillsDirectories, buildSystemPrompt } from '@/core/utils';
...
// 为子代理应用默认配置（强化提示词已在代理加载器中处理）
  ...
  // Build system prompt with coding-agent priority hint when any AI coding CLI tools are available
