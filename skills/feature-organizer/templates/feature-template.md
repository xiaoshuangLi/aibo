...
|----------|----------|----------|----------|------|
| 核心 Agent 逻辑 | X 个文件 | +X/-X 行 | X 小时 | [说明] |
| 工具（Tools） | X 个文件 | +X/-X 行 | X 小时 | [说明] |
| 基础设施（Infrastructure） | X 个文件 | +X/-X 行 | X 小时 | [说明] |
| 技能 / Agent 定义 | X 个文件 | +X/-X 行 | X 小时 | [说明] |
| 共享工具 / 类型 | X 个文件 | +X/-X 行 | X 小时 | [说明] |
| 配置 / 构建 | X 个文件 | +X/-X 行 | X 小时 | [说明] |
